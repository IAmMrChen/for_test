...
assert.ok(source.includes('point-log-card'), 'point log entry should keep its own row layout')
...
assert.ok(!source.includes('class="log-card"'), 'profile page should not render complete log cards')
